 ...
 * Controller
 */
angular.module('ngApp.home').controller('HomeController', function (AppSpinner, $scope, $location, $state, $stateParams, config, $filter, CountryService, CourierService, HomeService, SessionService, $uibModal, $log, toaster, SystemAlertService, DateFormatChange, $anchorScroll, $translate) {
