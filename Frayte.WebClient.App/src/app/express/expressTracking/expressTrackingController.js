angular.module('ngApp.breakBulk').controller("expressTrackingController", function ($scope, $uibModal, $translate, AppSpinner,$location,$anchorScroll, ModalService,SessionService, config, ExpressShipmentService, DateFormatChange, ExpressShipmentId) {
    ...
    $scope.GetExpressTracking = function () {
        ...
        ExpressShipmentService.GetExpressShipmentTracking($scope.ExpressShipmentId).then(function (response) {
    ...
    function init() {
        ...
        if (ExpressShipmentId != null) {
            $scope.ExpressShipmentId = ExpressShipmentId;
        }
