angular.module('ngApp.uploadShipment').controller('WithServiceMessageController', function ($scope, $uibModal, ShipmentData, ServiceType, config, $translate) {
    ...
    var setModalOptions = function () {
        ...
        'LoadingZonePostZipCode', 'Shipment_Is', 'Shipment_Are']).then(function (translations) {
