angular.module('ngApp.eCommerce').controller('eCommerceBookingController', function ($uibModalStack, PostCodeService, UtilityService, HSCodeService, $window, eCommerceBookingService, Upload, $rootScope, AppSpinner, $sce, TopCountryService, $location, $anchorScroll, TopCurrencyService, $scope, config, $filter, $state, ModalService, $translate, $uibModal, $timeout, toaster, $stateParams, DirectBookingService, SessionService) {
    ...
    $scope.SetPostCodeAddressValue = function (Type) {
        if (Type === "ShipFrom") {
            ...
            $scope.ToPostCodeAddressValue = false;
        }
    };
            ...
            return PostCodeService.AllPostCode(PostCode, CountryCode2).then(function (response) {
                ...
                if (response) {
                    ...
                    if (Type === "ShipFrom") {
                        ...
                        $scope.ToPostCodeAddressValue = true;
                    }
                }
                return response;
            }, function () {
    ...
    var shipToTabValid = function (DirectBookingForm) {
       ...
       DirectBookingForm.shipToMail !== undefined && DirectBookingForm.shipToMail.$valid
        ) {
                flag = true;
            }
            else {
    ...
    var setMultilingualOptions = function () {
        ...
        'FrayteServiceError_Validation', 'ReceiveDetail_Validation', 'InitialData_Validation', 'PackageAddeddSuccessfully', 'SetHSCodeProperly',
        'Confirmation', 'RemoveChangingParcelTypeDoc', 'Errorwhil_uploading_the_excel', 'SavingInfomation']).then(function (translations) {
            ...
            $scope.SetHSCodeProperly = translations.SetHSCodeProperly;
    ...
    function init() {
        ...
        if ($scope.RoleId === 1 || $scope.RoleId === 6) {
            ...
            eCommerceBookingService.GeteCommerceCustomers(userInfo.EmployeeId).then(function (response) {
