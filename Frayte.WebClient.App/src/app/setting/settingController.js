 ...
 * Controller
// */
angular.module('ngApp.setting').controller('SettingController', function ($scope, $state, $translate, uiGridConstants, SettingService, config, $filter, LogonService, SessionService, $uibModal, toaster, $rootScope) {
