...
angular.module('ngApp.systemAlert').
    controller('SystemAlertAddEditController', function (AppSpinner, SystemAlertService, $scope, systemAlert, systemAlertId, mode, ModalService, uiGridConstants, DirectShipmentService, config, DirectBookingService, $rootScope, $translate, $location, Upload, $state, $filter, ShipmentService, TimeZoneService, CountryService, CourierService, HomeService, ShipperService, ReceiverService, SessionService, $uibModal, $log, toaster, $stateParams, CustomerService, UserService, $uibModalInstance, TopTimeZoneService) {
        ...
        //    if (DirectBookingForm !== undefined && $scope.directBooking !== undefined && $scope.directBooking.ReferenceDetail !== undefined) {
        //        var d = new Date();
        //        var min = "";
