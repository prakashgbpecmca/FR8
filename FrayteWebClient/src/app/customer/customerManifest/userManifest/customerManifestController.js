...
.controller("UserManifestController", function ($scope, uiGridConstants, $uibModal, toaster, $window, $stateParams, SessionService, CustomerService, $rootScope, $http, config, AppSpinner, $translate, $state) {
