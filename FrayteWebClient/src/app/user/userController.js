...
angular.module('ngApp.user').controller('UserController', function ($scope, $state, UtilityService, $location, $filter, AppSpinner, $translate, UserService, SessionService, $uibModal, uiGridConstants, toaster, CountryService, ModalService) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
          ...
          { name: 'TelephoneNo', displayName: 'Phone_No', headerCellFilter: 'translate', width: '15%' },
          ...
          { name: 'ManagerUser.Email', displayName: 'Manager_Email', headerCellFilter: 'translate', width: '15%' },
    ...
    function init() {
        ...
        $scope.spinnerMessage = 'Loading Users';
        // Pagination Logic 
        $scope.viewby = 50;
        $scope.currentPage = 1;
