angular.module('ngApp.accessLevel')
   .controller("AccessLevelController", function ($scope, $state, AccessLevelService, SessionService, toaster, AppSpinner, $translate) {
       ...
       var setMultilingualOptions = function () {
           $translate(['SuccessfullyUpdated', 'CouldNotSetPermission', 'ErrorGettingRecord', 'FrayteError', 'FrayteSuccess']).then(function (translations) {
       ...
       $scope.saveRoleModulePermission = function (accessRole, ChildRoleModules) {
           ...
           AppSpinner.showSpinnerTemplate("Updating Access Level.", $scope.Template);
       ...
       var getInitialDetail = function () {
           AppSpinner.showSpinnerTemplate("Loading Access Level.", $scope.Template);
           AccessLevelService.GetRoleModules($scope.userInfo.EmployeeId, $scope.userInfo.RoleId).then(function (response) {
