...
{
    public partial class Manifest : DevExpress.XtraReports.UI.XtraReport
    {
        public Manifest()
        {
            InitializeComponent();
        ...
        private void xrRichText4_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            using (RichEditDocumentServer docServer = new RichEditDocumentServer())
            {
