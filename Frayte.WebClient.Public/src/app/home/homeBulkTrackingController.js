angular.module('ngApp.home').controller('HomeBulkTrackingController', function (AppSpinner, $scope, $translate, $anchorScroll, $location, $state, $stateParams, config, $filter, HomeService, SessionService, $log) {
    ...
    var setModalOptions = function () {
        $translate(['Address', 'Book', 'DeleteHeader', 'DeleteBody', 'Tradelane', 'SuccessfullySavedInformation', 'FrayteInformation',
                    ...
                    'detail', 'TrackingDetails_Validation', 'LoadingBulkTracking']).then(function (translations) {
