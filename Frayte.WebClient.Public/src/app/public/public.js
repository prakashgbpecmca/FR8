...
.config(function config($stateProvider, $locationProvider) {
    ...
    $stateProvider
       ...
       .state('public.directBookingConfirmReject', {
        ...
        .state('public.customer-action', {
            url: '/action/:actionType/:confirmationCode',
            templateUrl: 'public/publicCustomerAction/customerConfirmShipment.tpl.html',
            controller: 'PublicCustomerConfirmController',
            data: { pageTitle: 'Customer Action' }
        })


         .state('public.agent-action', {
             url: '/agent-action/:action',
             templateUrl: 'public/publicAgentMAWB/publicAgentMAWB.tpl.html',
             controller: 'AgentMAWBController',
    ...
    .state('public.systemAlertDetail', {
        url: '/service-alert-detail/:Heading',
