angular.module('ngApp.public').controller('DirectBookingConfirmRejectController', function ($scope, PublicService, $state, $stateParams, toaster, config, $translate) {
    var setMultilingualOptions = function () {
        ...
        'ErrorSavingRecord', 'FrayteError', 'FrayteSuccess', 'ErrorProcessingRequest']).then(function (translations) {
    ...
    var directBookingConfirmReject = function () {
        PublicService.DirectBookingConfirmReject($scope.actionType, $scope.directShipmentId).then(function (response) {
