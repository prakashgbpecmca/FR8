...
.factory("TopAirlineService", function () {
    var topAirlineOrder = function (AirlineStore) {
        ...
        for (var b = 0; b < AirlineData.length; b++) {
            if (AirlineData[b].AilineCode === "618") {
                Airlines.push({
        ...
        for (var c = 0; c < AirlineData.length; c++) {
            if (AirlineData[c].AilineCode === "160") {
                Airlines.push({
        ...
        for (var e = 0; e < AirlineData.length; e++) {
            if (AirlineData[e].AilineCode === "235") {
                Airlines.push({
        ...
        for (var g = 0; g < AirlineData.length; g++) {
            if (AirlineData[g].AilineCode === "176") {
                Airlines.push({
        ...
        for (var h = 0; h < AirlineData.length; h++) {
            if (AirlineData[h].AilineCode === "157") {
                Airlines.push({
        ...
        for (var i = 0; i < AirlineData.length; i++) {
            if (AirlineData[i].AilineCode === "81") {
                Airlines.push({
        ...
        //}
        var z = 7;
        for (var k = 0; k < AirlineData.length; k++) {
            Airlines.push({
